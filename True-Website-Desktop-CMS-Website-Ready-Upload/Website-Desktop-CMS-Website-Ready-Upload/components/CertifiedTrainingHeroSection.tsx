...
interface CertifiedTrainingHeroSectionProps {
  trainingMainData?: TrainingMainPage | null;
}

const CertifiedTrainingHeroSection: React.FC<
  CertifiedTrainingHeroSectionProps
> = ({ trainingMainData }) => {
  ...
  // Use CMS hero image or fallback to default
      ...
      <div className="max-w-[1300px] mx-auto px-6 pt-10 pb-20">
        ...
        <div className="relative rounded-[24px] w-full h-[315px] md:h-[400px] overflow-hidden">
          <Image
            ...
            alt="Training - Empower Teams, Elevate Performance"
            fill
...
export default CertifiedTrainingHeroSection;
